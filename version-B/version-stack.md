...
3. **UI Customization** - ✅ Partial - Auto-generate toggle added to Settings + first-run setup (2026-02-26). More options possible.
   ...
   - **Bug**: On regeneration, if an error occurs, the previously generated response disappears from the textarea. It should remain visible even when an error modal/message pops up — only clear it on a successful new generation.
